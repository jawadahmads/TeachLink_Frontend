        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center lg:items-start text-center lg:text-left">
          ...
          <div className="flex-1 w-full">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-10 border-t border-border/10">
              {[
                { label: "Community", value: teacherTotalStudents, icon: Users, color: "text-blue-500", bg: "bg-blue-500/10" },
                { label: "Mastery", value: `${teacherTotalHours}h`, icon: Video, color: "text-green-500", bg: "bg-green-500/10" },
                { label: "Response", value: teacherResponseTime, icon: Clock, color: "text-purple-500", bg: "bg-purple-500/10" },
                { label: "Dialogue", value: languages.length, icon: Languages, color: "text-orange-500", bg: "bg-orange-500/10" },
              ].map((stat, i) => (
                <div key={i} className="flex items-center justify-center lg:justify-start gap-4 group/stat">
                  <div className={`w-12 h-12 rounded-2xl ${stat.bg} ${stat.color} flex items-center justify-center group-hover/stat:scale-110 group-hover/stat:rotate-3 transition-all duration-500 shadow-sm`}>
