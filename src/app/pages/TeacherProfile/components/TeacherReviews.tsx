      ...
      <CardHeader className="p-10 md:p-12 pb-6 flex flex-row items-center justify-between">
        ...
        <div className="flex flex-col items-end">
          <div className="flex items-center gap-2 mb-1">
            <span className="font-black text-2xl tracking-tighter">{teacherRating}</span>
            <div className="flex">
              {[1, 2, 3, 4, 5].map((i) => (
                <Star
                  key={i}
          ...
          <span className="text-[10px] font-black text-muted-foreground/60 uppercase tracking-widest">Global Sentiment</span>
        </div>
      </CardHeader>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span className="text-[9px] font-black text-muted-foreground/40 uppercase tracking-[0.2em] ml-2">Verified Learner</span>
                      </div>
                    </div>
