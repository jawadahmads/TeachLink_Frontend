          ...
          >
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-4">
                <Button variant="outline" size="icon" className="h-18 w-18 rounded-[28px] border-2 border-border/10 bg-card/40 backdrop-blur-xl hover:bg-muted/50 transition-all active:scale-95 relative">
                                ...
                                <div className="flex-1 flex flex-wrap items-center gap-8 relative z-10 border-l border-border/10 pl-8 ml-2 lg:ml-0">
                                  <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex flex-col">
                                      <span className="text-[9px] font-black text-muted-foreground/80 uppercase tracking-widest leading-none mb-1">Date</span>
                                  ...
                                  <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex flex-col">
                                      <span className="text-[9px] font-black text-muted-foreground/80 uppercase tracking-widest leading-none mb-1">Time</span>
                          ...
                          {completedSessions.map((session, i) => (
                            ...
                            >
                              <Avatar className="h-12 w-12 border-2 border-background shadow-lg">
                                <AvatarImage src={session.studentAvatar} className="object-cover" />
                  ...
                  <CardContent className="p-10 pt-4 space-y-10">
                    <div className="space-y-4">
                      <div className="flex justify-between items-end">
                        <span className="font-black text-[10px] uppercase tracking-[0.2em] text-muted-foreground/60 leading-none">Global Impressions</span>
                        <span className="text-primary font-black text-2xl tracking-tighter leading-none">2.4k</span>
                      </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-end">
                        <span className="font-black text-[10px] uppercase tracking-[0.2em] text-muted-foreground/60 leading-none">Interests Conversion</span>
                        <span className="text-primary font-black text-2xl tracking-tighter leading-none">482</span>
                      </div>
                      <div className="h-4 w-full bg-background/50 rounded-full overflow-hidden p-1 shadow-inner group/progress">
                        <motion.div
                          initial={{ width: 0 }}
                  ...
                  <CardContent className="flex flex-col items-center justify-center text-center p-10 py-12 relative overflow-hidden">
                    ...
                    <div className="relative w-36 h-36 mb-8 group-hover:scale-110 transition-transform duration-1000">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <span className="text-5xl font-black tracking-tighter text-foreground">98</span>
                      </div>
                    </div>
                ...
                <Card className="border-none bg-gradient-to-br from-primary via-purple-700 to-indigo-900 text-primary-foreground shadow-[0_40px_80px_-20px_rgba(139,92,246,0.4)] rounded-[48px] overflow-hidden relative group">
                  ...
                  <CardContent className="p-10 pt-4 relative z-10">
                    <p className="text-lg font-medium opacity-80 mb-10 leading-relaxed max-w-[220px]">
                      A short video intro can ignite your booking rate by <span className="text-white font-black underline decoration-4 decoration-white/30 underline-offset-4">35%</span>.
                    </p>
                    <Button
                      variant="secondary"
