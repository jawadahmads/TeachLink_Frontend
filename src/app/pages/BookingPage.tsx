                  ...
                  <div>
                    ...
                    <RadioGroup value={duration} onValueChange={setDuration}>
                      <div className="flex items-center space-x-2 mb-2">
                        ...
                        <Label htmlFor="30" className="cursor-pointer">30 minutes - ${teacher.hourlyRate / 2}</Label>
                      </div>
                      <div className="flex items-center space-x-2 mb-2">
                        <RadioGroupItem value="60" id="60" />
                        <Label htmlFor="60" className="cursor-pointer">60 minutes - ${teacher.hourlyRate}</Label>
                      </div>
                      <div className="flex items-center space-x-2">
                        <RadioGroupItem value="90" id="90" />
                        <Label htmlFor="90" className="cursor-pointer">90 minutes - ${teacher.hourlyRate * 1.5}</Label>
                      </div>
                    </RadioGroup>
                  </div>
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        <h4 className="font-medium text-blue-900 mb-1">Mock Payment</h4>
                        <p className="text-sm text-blue-700">
                          This is a demo. In a real application, you would enter your payment details here using a secure payment processor like Stripe.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <CardContent className="space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <Link to={`/teacher/${teacher.id}`} className="text-sm text-primary hover:underline">
                      View Profile
                    </Link>
                  </div>
                </div>
