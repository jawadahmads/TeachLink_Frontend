        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="flex-1">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2.5">
                  ...
                  {teacher.subjects && teacher.subjects.length > 4 && (
                    <Badge
                      variant="secondary"
                      className="text-[10px] font-black px-3 text-primary/60 bg-primary/5 border-none"
                    >
            ...
            <p className="text-muted-foreground/80 text-base font-medium leading-relaxed mb-8 line-clamp-2 sm:line-clamp-3 max-w-2xl">
              {teacher.gigTitle && (
                <span className="font-black text-foreground block mb-2 text-lg tracking-tight leading-none">
                  {teacher.gigTitle}
                </span>
              )}
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              ...
              <Link
                to={isTeacher ? "#" : `/booking/${teacher.id}`}
                className="flex-1"
              >
                <Button
                  ...
                  onClick={() =>
                    isTeacher &&
                    toast.info("Students can only book tutoring sessions")
                  }
                >
                  Book Session Now
                </Button>
