...
import TeacherGig from "./TeacherGig";
      ...
      <div>
        ...
        <div className="space-y-4 max-h-[400px] overflow-y-auto pr-4 custom-scrollbar">
          {subjects.map((subject) => (
            ...
            >
              <div
                className={`w-6 h-6 rounded-lg border-2 flex items-center justify-center transition-all duration-300 ${selectedSubjects.includes(subject) ? "bg-primary border-primary shadow-lg shadow-primary/20" : "border-border/40 group-hover:border-primary/40"}`}
              >
      ...
      <div>
        ...
        <Select value={priceRange} onValueChange={setPriceRange}>
          ...
          <SelectContent className="rounded-2xl border border-border/10 bg-card/90 backdrop-blur-2xl p-2">
            ...
            <SelectItem value="low" className="rounded-xl font-bold py-3">
              Economy (Under $40/hr)
            </SelectItem>
            <SelectItem value="medium" className="rounded-xl font-bold py-3">
              Professional ($40-50/hr)
            </SelectItem>
            <SelectItem value="high" className="rounded-xl font-bold py-3">
              Elite ($50+/hr)
            </SelectItem>
          </SelectContent>
        </Select>
      ...
      <div>
        ...
        <Select value={selectedDay} onValueChange={setSelectedDay}>
          ...
          <SelectContent className="rounded-2xl border border-border/10 bg-card/90 backdrop-blur-2xl p-2">
            ...
            <SelectItem value="Monday" className="rounded-xl font-bold py-3">
              Monday Session
            </SelectItem>
            <SelectItem value="Tuesday" className="rounded-xl font-bold py-3">
              Tuesday Session
            </SelectItem>
            <SelectItem value="Wednesday" className="rounded-xl font-bold py-3">
              Wednesday Session
            </SelectItem>
            <SelectItem value="Thursday" className="rounded-xl font-bold py-3">
              Thursday Session
            </SelectItem>
            <SelectItem value="Friday" className="rounded-xl font-bold py-3">
              Friday Session
            </SelectItem>
            <SelectItem value="Saturday" className="rounded-xl font-bold py-3">
              Weekend: Saturday
            </SelectItem>
            <SelectItem value="Sunday" className="rounded-xl font-bold py-3">
              Weekend: Sunday
            </SelectItem>
          </SelectContent>
        </Select>
