...
import { adminStats, mockTeachers, mockSessions } from "../../data/mockData";
          ...
          >
            ...
            <div className="flex items-center gap-4">
              <Button
                variant="outline"
                size="lg"
                className="h-14 px-6 rounded-2xl border-2 font-black text-xs uppercase tracking-widest hover:bg-muted/50 transition-all"
              >
              ...
              <Button
                size="lg"
                className="h-14 px-8 rounded-2xl font-black text-sm uppercase tracking-widest shadow-2xl shadow-primary/25 hover:shadow-primary/40 transition-all group"
              >
                System Reports
            ...
            {[
              ...
              >
                <CardContent className="p-8 relative">
                  <div
                    className={`absolute -top-6 -right-6 w-24 h-24 ${stat.bg} rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity`}
                  />

                  <div className="flex justify-between items-start mb-6">
                    <div
                      className={`w-14 h-14 rounded-2xl ${stat.bg} flex items-center justify-center group-hover:scale-110 transition-transform shadow-inner`}
                    >
                    ...
                    <div className="flex flex-col items-end">
                      <Badge
                        variant="secondary"
                        className="bg-muted/50 font-black text-[10px] px-2 py-0.5 rounded-lg border-none mb-1"
                      >
                        {stat.trend}
                      </Badge>
                  ...
                  <div className="p-8 pb-0 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
                    ...
                    <div className="flex items-center gap-3">
                      <Button
                        variant="ghost"
                        size="icon"
                        className="rounded-xl bg-muted/30 hover:bg-muted/50 h-10 w-10"
                      >
                    ...
                    <Tabs defaultValue="revenue" className="w-full">
                      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-8 mb-10 bg-muted/20 p-6 rounded-[32px] border border-white/5">
                        <TabsList className="bg-background/50 p-1 rounded-2xl inline-flex shadow-inner">
                          <TabsTrigger
                            value="revenue"
                            className="rounded-xl font-black uppercase tracking-widest text-[10px] px-8 py-3 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground transition-all duration-300"
                          >
                            Revenue
                          </TabsTrigger>
                          <TabsTrigger
                ...
                <Tabs defaultValue="teachers" className="w-full">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                    <TabsList className="bg-muted/40 p-1 rounded-2xl inline-flex w-fit shadow-sm">
                      <TabsTrigger
                        value="teachers"
                        className="rounded-xl font-black uppercase tracking-widest text-[10px] px-6 py-3 data-[state=active]:bg-background transition-all duration-300"
                      >
                        Top Teachers
                      </TabsTrigger>
                      <TabsTrigger
                        ...
                        <Table>
                          <TableHeader>
                            <TableRow className="border-none bg-muted/20 hover:bg-muted/20">
                              ...
                              <TableHead className="font-black uppercase tracking-widest text-[10px] text-right pr-12">
                                Total Earnings
                              </TableHead>
                            </TableRow>
                          </TableHeader>
                          <TableBody>
                            {topTeachers.map((teacher) => (
                              <TableRow
                                key={teacher.id}
                                className="border-border/40 hover:bg-primary/5 transition-all group"
                              >
                                ...
                                <TableCell className="text-right pr-12">
                                  <div className="font-black text-sm text-emerald-600">
                                    $
                                    {(
                                      teacher.totalHours * teacher.hourlyRate
                                    ).toLocaleString()}
                                  </div>
                                ...
                                <TableCell className="py-6 pl-8">
                                  <div className="flex flex-col">
                                    ...
                                    <span className="text-[10px] font-bold text-muted-foreground/60">
                                      {session.teacherName}{" "}
                                      <ArrowRight className="inline h-2 w-2 mx-1" />{" "}
                                      {session.studentName}
                                    </span>
                                  </div>
                                </TableCell>
                  ...
                  <CardContent className="p-8 pt-0 space-y-6">
                    <div className="space-y-4">
                      {[
                        ...
                        <div
                          key={i}
                          className="flex items-center justify-between p-4 rounded-2xl bg-muted/30 border border-border/50 group hover:bg-muted/50 transition-all cursor-pointer"
                        >
                          <div className="flex items-center gap-4">
                            <div
                              className={`w-10 h-10 rounded-xl ${item.bg} flex items-center justify-center transition-transform group-hover:scale-110 shadow-inner`}
                            >
                ...
                <Card className="border-none bg-primary text-primary-foreground shadow-2xl shadow-primary/30 rounded-[32px] overflow-hidden relative group border border-white/10">
                  ...
                  <CardContent className="p-8 pt-0 relative z-10">
                    <p className="text-sm font-medium opacity-90 mb-8 leading-relaxed">
                      Comprehensive weekly audit and platform scalability
                      projections are prepared for distribution.
                    </p>
                    <Button
                      variant="secondary"
